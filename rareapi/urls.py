...
from .views import login_user, register_user, tags, tag_detail, post_list, post_detail, post_tags, category_list, category_detail, my_post_list, post_comments, comment_detail, profile_list, profile_detail, deactivate_user, reactivate_user, user_post_list, subscribe, unsubscribe, subscribed_posts
